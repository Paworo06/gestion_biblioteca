...
<head>
    ...
    <style>
        ...
        .filtros input[type="date"] { padding: 8px; border: 1px solid #ccc; border-radius: 4px; }
        .filtros button { padding: 8px 16px; background: #3b82f6; color: #fff; border: none; border-radius: 4px; cursor: pointer; }
...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr><td colspan="6" class="empty">No hay reservas.</td></tr>
            @endforelse
        </tbody>
    </table>
</body>
